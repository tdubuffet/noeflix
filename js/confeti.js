window.confettiKit = function(t) {
    ...
    e.renderStar = function(t, e) {
            ...
            for (var l = 0, a = [], d = 0; d <= n; d++) {
                ...
                o.elements.star && i > 0) {
                    ...
                    h == f ? (m.style["background-color"] = u,
                        ...
                        m.direction = o.elements.confetti && o.elements.confetti.direction ? o.elements.confetti.direction : "down",
                        m.rotation = !o.elements.confetti || !o.elements.confetti.rotation || o.elements.confetti.rotation;
        ...
        e.updateFetti = function(t, e, n) {
            t.physics.x += Math.cos(t.physics.angle2D) * t.physics.velocity,
                ...
                "up" == t.element.direction ? t.physics.y -= 3 : t.physics.y += 3,
                t.physics.tiltAngle += .1;
            var o, i = t.physics.x, s = t.physics.y, c = t.physics.tiltAngle, r = t.physics.wobble, l = i + 10 * Math.cos(r), a = s + 10 * Math.sin(r);
    ...
    if (null != o.position) {
        if ("bottomLeftRight" == o.position)
            o.angle = 45,
                e.confetti(i, 0, window.innerHeight - 200),
                (s = t).position = null,
                s.angle = 135,
